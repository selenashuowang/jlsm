...
#' unipartite social networks with bipartite attribute networks. The latent space models are implemented using a fast
...
#' Both the Euclidean distances and the vector distances are used to describe relationships among perons and between persons and attributes.
#'
